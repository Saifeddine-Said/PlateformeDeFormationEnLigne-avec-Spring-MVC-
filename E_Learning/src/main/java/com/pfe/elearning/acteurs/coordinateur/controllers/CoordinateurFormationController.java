...
@Controller
@RequestMapping(value = "/coordinateur/formations")
@SessionAttributes("editedForm")
public class CoordinateurFormationController {
	...
	public String indexFormation(Model model, HttpServletRequest request) {
		...
		model.addAttribute("listFormations", form);
		model.addAttribute("collapse", "collapse");
		model.addAttribute("formation", new Formation());
		return "/coordinateur/formation";
	}
	...
	public String modifierFormation(Model model, Long idFormation) {
		...
		model.addAttribute("collapse", "");
		List<Formation> form = metierFormation.selectAll();
		model.addAttribute("listFormations", form);
		return "/coordinateur/formation";
	}

	@RequestMapping(value = "/supprimerFormation")
	public String supprimerFormation(Formation formation, Model model) {
		metierFormation.supprimer(formation.getIdFormation());
		...
		model.addAttribute("lstFormation", form);
		model.addAttribute("formation", new Formation());
		return "redirect:/coordinateur/formations/";
	}
	...
	public byte[] photoFormation(Long idFormation) throws IOException {
		Formation form = metierFormation.findById(idFormation);
