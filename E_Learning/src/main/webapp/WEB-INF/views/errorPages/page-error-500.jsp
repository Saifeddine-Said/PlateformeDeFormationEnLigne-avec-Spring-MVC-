                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="panel panel-minimal" style="margin-top:10%;">
                            ...
                            <div class="panel-body text-center">
                                <h1 class="semibold longshadow text-center text-default fsize32 mb10 mt0"> ERREUR INTERNE DU SERVEUR!!</h1>
                                <h4 class="semibold text-primary text-center nm">Erreur inattendue a été détectée...</h4>
                            </div>
                            <!--/ Upper Text -->
