...
<body>
  ...
  <aside class="sidebar sidebar-left sidebar-menu">
    ...
    <section class="content slimscroll">
      ...
      <ul class="topmenu topmenu-responsive" data-toggle="menu">
        ...
        <li class="active open"><a href="${moduleLink }" data-toggle="submenu" data-target="#form" data-parent=".topmenu"> <span class="figure"><i class="ico-quill2"></i></span> <span class="text">Modules</span> <span class="arrow"></span>
        </a></li>
        ...
        <li><a href="${emailLink }" data-toggle="submenu" data-target="#chart" data-parent=".topmenu"> 
  ...
  <section id="main" role="main">
    ...
    <div class="container-fluid">
        ...
        <div class="page-header-section">
          ...
          <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
             <li><button type="submit" class="btn btn-primary" data-toggle="collapse" data-target="#ajouterModule">
      ...
      <!-- section header -->
      <div class="panel panel-default ${collapse }" data-expanded="false" id="ajouterModule">
        <!-- Form horizontal layout -->
        <f:form modelAttribute="module" method="post" class="form-horizontal panel panel-default" action="enregistrerModule" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <f:errors path="nomModule" cssClass="errors" />
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <f:errors path="descriptionModule" />
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-4">Formation</label>
              <div class="col-sm-8">
                <f:select path="formation.idFormation" items="${formations }" itemLabel="nomFormation" itemValue="idFormation" class="form-control" />
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="panel-footer">
            ...
            <button type="reset" class="btn btn-danger" data-toggle="collapse" data-target="#ajouterModule">Annuler</button>
          </div>
        </f:form>
        <!--/ Form horizontal layout -->
      </div>
            ...
            <div class="widget panel panel-default animation" data-toggle="waypoints" data-showanim="slideInLeft" data-hideanim="slideOutRight" data-offset="80%">
              ...
              <div class="panel-body panel-toolbar">
                <div class="panel-toolbar text-right">
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <c:if test="${module.getCoordinateur().getIdUtilisateur() == user.getIdUtilisateur() }">
                        <li><a class="ico-edit" href="<c:url value="/coordinateur/modules/modifierModule?idModule=${module.getIdModule() }"/>"> Modifier</a></li>
                        <li class="divider"></li>
                ...
                <ul class="list-unstyled">
                  <li class="text-center mb15"><a href="modules?id=${module.getIdModule()}&app=${user.getIdUtilisateur()}"><img class="img-rounded img-bordered-primary" src="<c:url value="/photos/photoModule?idModule=${module.getIdModule() }" />" alt="" width="100px" height="100px" /></a></li>
                  <li class="text-center mb10">
                    <h4 class="semibold ellipsis nm">
                      <span class="text-primary"><a href="modules?id=${module.getIdModule()}&app=${user.getIdUtilisateur()}">${module.getNomModule() }</a></span>
                    </h4>
                    <p class="text-muted nm">Par ${module.getCoordinateur().getNom()} ${module.getCoordinateur().getPrenom() }</p>
                  </li>
                  <li class="text-center">
                  
                  <c:set var="desc" value="${module.getDescriptionModule() }" />
                  ${fn:substring(desc, 0, 37) }...
                  </li>
                </ul>
                <!--    <ul class="list-unstyled">
                  <li class="text-center">
