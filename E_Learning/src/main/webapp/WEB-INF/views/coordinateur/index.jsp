		...
		<div class="container-fluid">
			...
			<section class="jumbotron jumbotron-bg7 jumbotron mt-15 mb15 mr-15 ml-15" data-stellar-background-ratio="0.4" style="min-height: 320px;">
				...
				<div class="container" style="padding-top: 8%;">
					<h1 class="thin text-white text-center font-alt">Bienvenu de nouveau ${user.getNom() } ${user.getPrenom() }.</h1>
					<h4 class="thin text-white text-center">Vous pouvez voir ce que vos collegues ont fait...</h4>
				</div>
			</section>
			<!--/ END jumbotron -->
				...
				<div class="col-md-9">
					...
					<ul class="timeline">
						...
						<li class="wrapper">
							<!-- START Events -->
							<ul class="events">
								<c:forEach items="${formsAutres }" var="forms">
									<li class="wrapper">
										...
										<div class="panel">
											<div class="panel-body">
												<ul class="list-table">
													<li class="text-left" style="width: 60px;"><img class="img-circle" src="<c:url value="/photos/photoUser?idUser=${forms.getCoordinateur().getIdUtilisateur() }" />" alt="" width="50px" height="50px"></li>
													<li class="text-left">
														<p class="mb5">
															<span class="semibold">${forms.getCoordinateur().getNom() } ${forms.getCoordinateur().getPrenom() }</span> a cree une nouvelle formation
														</p>
														<h5 class="text-accent semibold nm">${forms.getNomFormation() }</h5>
													</li>
												</ul>
											</div>
										</div> <!--/ panel -->
								...
								<c:forEach items="${modsAutres }" var="mods">
									<li class="wrapper">
										<div class="figure bgcolor-success">
											<i class="ico-file-plus"></i>
										</div> <!-- panel -->
										<div class="panel">
											<div class="panel-body">
												<ul class="list-table">
													<li class="text-left" style="width: 60px;"><img class="img-circle" src="<c:url value="/photos/photoUser?idUser=${mods.getCoordinateur().getIdUtilisateur() }" />" alt="" width="50px" height="50px"></li>
													<li class="text-left">
														<p class="mb5">
															<span class="semibold">${mods.getCoordinateur().getNom() } ${mods.getCoordinateur().getPrenom() }</span> a cree un nouveau module
														</p>
														<h5 class="text-accent semibold nm">${mods.getNomModule() }</h5>
													</li>
												</ul>
											</div>
										</div> <!--/ panel -->
						...
						<li class="header text-center semibold nm"><a href="javascript:void(0);">Charger plus</a></li>
					</ul>
					<!--/ END Timeline -->
				</div>
				<!--/ Left side / top side -->
					...
					<div class="panel panel-minimal nm">
						...
						<div class="panel-toolbar-wrapper">
							<div class="panel-toolbar">
								<h5 class="semibold nm text-info">Resume</h5>
							</div>
						</div>
						<div class="panel-body pt0 pb0">
							<ul class="list-table">
								<li style="width: 55px;"><img class="img-circle" src="<c:url value="/photos/photoUser?idUser=${user.getIdUtilisateur() }" />" alt="" width="45px" height="45px"></li>
								<li class="text-left">
						...
						<ul class="nav nav-justified mt15">
							<li class="text-center">
								<h4 class="nm">${formations.size() }</h4>
								<p class="nm text-muted">Formations</p>
							</li>
							<li class="text-center">
								<h4 class="nm">${modules.size() }</h4>
								<p class="nm text-muted">Modules</p>
							</li>
							<li class="text-center">
								<h4 class="nm">16</h4>
								<p class="nm text-muted">Chapitres</p>
							</li>
						</ul>
						<!--/ END Twitter Widget -->
						...
						<div class="panel-toolbar-wrapper">
							<div class="panel-toolbar">
								<h5 class="semibold nm text-info">
									<i class="ico-users3 mr5"></i>Collegues (Coordinateurs)
								</h5>
							</div>
						...
						<div class="panel-body pt0">
							<div class="media-list media-list-contact">
								<c:forEach items="${coordinateurs }" var="coor">
									<a href="page-message-rich.html" class="media"> <span class="media-object pull-left"> <img src="<c:url value="/photos/photoUser?idUser=${coor.getIdUtilisateur() }" />" class="img-circle" alt="">
									</span> <span class="media-body"> <span class="media-heading"><span class="hasnotification hasnotification-success mr5"></span> ${coor.getNom() } ${coor.getPrenom() }</span>
									</span>
									</a>
								</c:forEach>
							<p class="nm">
								<a href="javascript:void(0);" class="semibold">Voir tous</a>
							</p>
						</div>
						<!--/ END Friend lists -->
					</div>
