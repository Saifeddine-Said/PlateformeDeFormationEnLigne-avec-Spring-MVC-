			...
			<div class="table-layout">
				...
				<div class="col-lg-3 valign-top panel panel-minimal">
					...
					<div class="panel-body">
						...
						<c:url value="/coordinateur/email/" var="recived"/>
							<a href="${recived }" class="list-group-item">
							<i class="ico-drawer mr5"></i> Boite de reception <span class="semibold text-muted pull-right">${listEmail.size() }</span>
							</a> 
							<c:url value="/coordinateur/email/send" var="send"/>
							<a href="${send }" class="list-group-item"><i class="ico-paper-plane mr5"></i> Messages envoyes <span class="semibold text-muted pull-right">${listEmailEnv.size() }</span>
							</a> 
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-pen3 mr5"></i> Brouillons <span class="semibold text-muted pull-right"></span>
							</a> 
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-remove2 mr5"></i> Corbeille
							</a>
						</div>
						<!--/ Browse -->
						<!-- Label -->
						...
						<div class="list-group">
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-square text-danger mr5"></i> Message non lu</a> 
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-square text-muted mr5"></i> Message lu</a> 
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-square text-teal mr5"></i> Message important</a> 
							<a href="javascript:void(0);" class="list-group-item"><i class="ico-square text-success mr5"></i> Message normal</a>
						</div>
						<!--/ Label-->
				...
				<div class="col-lg-8 valign-top panel panel-default">
					...
					<form action="" style="display:none">
					 <input type="hidden" id="nbrMailNonLu" value="${listEmailNonLu.size() }">
					 <select id="listMails">
									...
									<td class="message">
										<h5 class="heading">
										  <c:choose>
											...
											<c:url value="/coordinateur/email/detailMail?idEmail=${mail.getIdEmail() }&lu=${lu }" var="mailDetail" />
											<a href="${mailDetail }">${mail.getObjetEmail() }</a>
										</h5>
										<p class="text">
										<c:set var="sujet" value="${mail.getSujetEmail() }"></c:set>
										${fn:substring(sujet, 0, 50) }...</p>
									</td>
								</tr>
								</c:forEach>
							</tbody>
				...
				<div class="modal-dialog">
					<f:form modelAttribute="sendmail" class="modal-content" action="envoyerEmail" parsley-validate="parsley-validate" method="post">
						<div class="modal-header text-center">
							...
							<p class="text-muted">Les champs avec <span class="text-danger">*</span> sont obligatoires </p>
						</div>
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label">A <span class="text-danger">*</span></label> 
										<input type="text" id="selectize-contact" name="mailAdr" class="form-control" placeholder="Select contact..." />
									</div>
									<div class="form-group">
