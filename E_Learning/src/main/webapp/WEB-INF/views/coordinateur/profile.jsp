		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-3">
					...
					<ul class="list-table">
						<li style="width: 70px;"><img class="img-circle img-bordered" src="<c:url value="/photos/photoUser?idUser=${user.getIdUtilisateur() }" />" alt="" width="65px"></li>
						<li class="text-left">
							...
							<div style="max-width: 200px;">
								...
								<p class="text-muted clearfix nm">
									<span class="pull-left">Profile complet</span> <span class="pull-right">70%</span>
								</p>
							</div>
						</li>
					</ul>
					...
					<ul class="nav nav-section nav-justified mt15">
						<li>
							<div class="section">
								<h4 class="nm semibold">${formations.size() }</h4>
								<p class="nm text-muted">Formations crees</p>
							</div>
						</li>
						<li>
							<div class="section">
								<h4 class="nm semibold">${modules.size() }</h4>
								<p class="nm text-muted">Modules crees</p>
							</div>
						</li>
						<li>
							<div class="section">
				...
				<div class="col-lg-9">
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="profile">
							<!-- form profile -->
							<f:form modelAttribute="utilisateur" enctype="multipart/form-data" class="panel form-horizontal form-bordered" name="form-profile">
								<div class="panel-body pt0 pb0">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="btn-group pr5">
												<img class="img-circle img-bordered" src="<c:url value="/photos/photoUser?idUser=${user.getIdUtilisateur() }" />" alt="" width="34px">
											</div>
											<div class="btn-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<f:input path="dateNaissance" class="form-control" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Apropos</label>
										<div class="col-sm-6">
											<f:textarea path="apropos" class="form-control" rows="3"></f:textarea>
