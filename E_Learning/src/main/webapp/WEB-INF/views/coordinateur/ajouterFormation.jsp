			...
			<div class="col-md-6">
				...
				<f:form modelAttribute="formation" method="post" class="form-horizontal panel panel-default" action="enregistrerFormation" enctype="multipart/form-data">
					<div class="panel-heading">
						<h3 class="panel-title">Nouvelle formation</h3>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<f:input path="nomFormation" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<f:textarea path="descriptionFormation" class="form-control"></f:textarea>
