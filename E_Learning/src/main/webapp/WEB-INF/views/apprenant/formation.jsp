<%@page import="com.pfe.elearning.entities.Formation"%>
						...
						<div class="panel nm">
							...
							<div class="thumbnail">
								...
								<div class="media">
									...
									<!--/ indicator -->
									<img data-toggle="unveil" src="/photos/photoUseA?idUser=${user.getIdUtilisateur() }" data-src="<c:url value="/photos/photoUserA?idUser=${user.getIdUtilisateur() }" />" alt="Cover" width="100%">
								</div>
								<!--/ media -->
							</div>
							<!--/ thumbnail -->
							...
							<div class="panel-body">
								<ul class="list-unstyled">
									<li class="text-center mb15">
										<a href="modules?id=${forma.getIdFormation()}">
										<img class="img-rounded img-bordered-primary" src="photoFormation?idFormation=${forma.getIdFormation() }" alt="" width="100px" height="100px" />
										</a>
									</li>
									<li class="text-center mb10">
										<h4 class="semibold ellipsis nm">
											<span class="text-primary">
												<a href="modules?id=${forma.getIdFormation()}">${forma.getNomFormation() }</a>
											</span>
										</h4>
										
									</li>
									<li class="text-center"><c:set var="description" value="${forma.getDescriptionFormation() }"></c:set>
