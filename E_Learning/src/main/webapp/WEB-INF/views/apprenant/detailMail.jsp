	...
	<aside class="sidebar sidebar-left sidebar-menu">
		...
		<section class="content slimscroll">
			...
			<ul class="topmenu topmenu-responsive" data-toggle="menu">
				...
				<li class="active open"><a href="${indexLink }"
					data-target="#dashboard" data-toggle="submenu"
					data-parent=".topmenu"> <span class="figure"><i
							class="ico-dashboard2"></i></span> <span class="text">Acceuil</span> <span
						class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/formations/" var="formationLink" />
				<li><a href="${formationLink }" data-target="#components"
					data-toggle="submenu" data-parent=".topmenu"> <span
						class="figure"> <i class="ico-screwdriver"></i>
					</span> <span class="text">Formations</span> <span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/modules/" var="moduleLink" />
				<li><a href="${moduleLink }" data-toggle="submenu"
					data-target="#form" data-parent=".topmenu"> <span
						class="figure"><i class="ico-quill2"></i></span> <span
						class="text">Modules</span> <span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/chapitres/" var="chapitreLink" />
				<li><a href="${chapitreLink }" data-toggle="submenu"
					data-target="#table" data-parent=".topmenu"> <span
						class="figure"><i class="ico-numbered-list"></i></span> <span
						class="text">Chapitres</span> <span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/contenus/" var="contenusLink" />
				<li><a href="${contenusLink }" data-toggle="submenu"
					data-target="#table" data-parent=".topmenu"> <span
						class="figure"><i class="ico-stack"></i></span> <span class="text">Contenu
							Chapitre</span> <span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/examens/" var="examenLink" />
				<li><a href="${examenLink }" data-toggle="submenu"
					data-target="#page" data-parent=".topmenu"> <span
						class="figure"><i class="ico-file6"></i></span> <span class="text">Examens</span>
						<span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/email/" var="emailLink" />
				<li><a href="${emailLink }" data-toggle="submenu"
					data-target="#chart" data-parent=".topmenu"> <span
						class="figure"><i class="ico-mail2"></i></span> <span class="text">EMail</span>
					<c:if test="${nbrMails > 0 }">
				...
				<li><a href="${espaceLink }" data-toggle="submenu"
					data-target="#maps" data-parent=".topmenu"> <span
						class="figure"> <i class="ico-folder-open"></i>
					</span> <span class="text">Mon Espace</span> <span class="arrow"></span>
				</a></li>
				<c:url value="/coordinateur/forum/" var="forumLink" />
				<li><a href="${forumLink }" data-toggle="submenu"
					data-target="#layout" data-parent=".topmenu"> <span
						class="figure"><i class="ico-question"></i></span> <span
						class="text">Forum</span> <span class="arrow"></span>
				</a></li>
			</ul>
			...
			<div class="table-layout">
				...
				<div class="col-lg-8 valign-top panel panel-default">
					...
					<div class="panel-body">
						...
						<ul class="list-table">
							<li style="width: 70px;"><img class="img-circle" src="<c:url value="/photos/photoUserA?idUser=${email.getUtilisateurExpeditreur().getIdUtilisateur() }" />" alt="" width="65px" height="65px"></li>
							<li class="text-left">
