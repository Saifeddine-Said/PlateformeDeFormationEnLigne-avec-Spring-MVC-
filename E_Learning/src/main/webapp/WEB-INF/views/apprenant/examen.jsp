            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">${examen.getModule().getNomModule()}/${examen.getChapitres().getTitreChapitre()}</h4>
                    </div>
				...
				<div class="item panel no-border">
                                <div class="panel-body text-center">
                                    <h4 class="semibold mb5">${examen.getTitreExamen() }</h4>
                                    <p class="nm text-muted">${examen.getDescriptionExamen() }</p>
                                    <p>Ce examen d'évolution contient ... questions  de type ${examen.getTypeExamen()}</p>
                                </div>
                            </div>
